angular.module('mean.system')
  .controller('GameController', [
    ...
    '$http',
    function ($scope, game, $timeout, $location, MakeAWishFactsService, $dialog, $http) {
      ...
      $scope.getUserInfo = (email, searchForm) => {
        if (searchForm.$dirty) {
          $scope.resetForm();
          ...
          $http({
            ...
            data: {
              email: $scope.getUserEmail(email)
            }
          }).then((response) => {
      ...
      $scope.sendGameInvite = () => {
        if (game.message === 'User successfully found') {
          $http({
            ...
            console.log(game.inviteMessage);
